...
const siteDescription =
  "AGFusion is an AI-assisted workspace for payments, treasury, agents, and developers on Arc — the Economic OS for programmable money with USDC gas and sub-second finality.";
