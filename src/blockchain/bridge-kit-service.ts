...
export async function runBridgeKitFlow(params: {
  ...
  // Ensure the user's selected wallet is on the source chain before the first
  // signature. Bridge Kit still performs chain-aware switching as needed.
  ...
  // Never report success without the destination mint/receive transaction.
